...
class Repository {
    companion object {
        var movieList= mutableListOf(
            ...
            Movie(3, "300 Спартанцев", "События картины повествуют о кровопролитной битве при Фермопилах в 480 году до н.э., в которой триста отважных спартанцев во главе со своим царем Леонидом преградили путь многотысячной армии персидского царя Ксеркса.",R.drawable.ic_300_foreground),
